          ...
          return (
            <TableRow
              ...
              className={`!over:bg-none !border-b-DEFAULT ${
                isDebit || amount.charAt(0) === "-" ? "bg-[#fffbfa]" : "bg-[#f6fef9]"
              }`}
            >
              ...
              <TableCell
                className={`pl-2 pr-10 font-semibold ${
                  isDebit || amount.charAt(0) === "-" ? "text-[#f04438]" : "text-[#039855]"
                }`}
              >
              ...
              <TableCell className="pl-2 pr-10 min-w-24">{t.paymentChannel}</TableCell>
